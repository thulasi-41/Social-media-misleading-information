...
from social_mediaand_misleading_information import settings
...
urlpatterns = [
    ...
    url(r'^Find_Social_Media_News_Type_Ratio/$', serviceprovider.Find_Social_Media_News_Type_Ratio, name="Find_Social_Media_News_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^Predict_Social_Media_News_Type/$', serviceprovider.Predict_Social_Media_News_Type, name="Predict_Social_Media_News_Type"),
